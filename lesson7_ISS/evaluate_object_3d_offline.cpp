...
int main () {
  ...
  //string result_dir = argv[2];
   ...
   string  gt_dir = "/home/zc/MyFiles/points/dataset/KITTI/data_object_label_2/training/label_2";
   string  result_dir = "/home/zc/MyFiles/points/code/lesson6/kitti_eval/pred";
