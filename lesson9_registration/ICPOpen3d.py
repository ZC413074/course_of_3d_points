...
if __name__ == '__main__':
    ...
    for index, filename in enumerate(content):
        ...
        # step3 iss 特征提取
        after_voxel_size = original_voxel_size*2
        points_source_iss = o3d.geometry.keypoint.compute_iss_keypoints(points_source_dawnsample,
                                                                        salient_radius=after_voxel_size,
                                                                        non_max_radius=after_voxel_size*2,
                                                                        gamma_21=0.5,
                                                                        gamma_32=0.5)
        ...
        # step4 fpfh 特征点描述
        search_type = o3d.geometry.KDTreeSearchParamRadius(radius=after_voxel_size*2)
        ...
        # step4 ransac icp
        result = execute_global_registration(points_source_dawnsample, points_target_dawnsample, points_source_fpfh, points_target_fpfh, after_voxel_size*2)
        print(result)
